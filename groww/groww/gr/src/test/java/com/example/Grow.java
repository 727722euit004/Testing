...
public class Grow {
    ...
    public void before() throws Exception{
        ExtentSparkReporter exsprk = new ExtentSparkReporter("D:\\Software Testing\\Model\\groww\\report\\report1.html");
    ...
    public void test1() throws Exception{
        ...
        FileInputStream fs = new FileInputStream("D:\\Software Testing\\Model\\groww\\gr.xlsx");
    ...
    public void afterTest(ITestResult result) throws Exception{
        if(result.getStatus()==ITestResult.FAILURE)
        {
            ...
            String path = "D:\\Software Testing\\Model\\groww\\report\\"+result.getName()+"png";
